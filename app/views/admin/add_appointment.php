    ...
    Swal.fire({
      ...
      html: `
        <div style="text-align:left;margin-bottom:1rem;">
          <b>Appointment has been created successfully.</b>
        </div>
        <div style="padding:1rem;background:#fff3cd;border:2px solid #ffc107;border-radius:10px;font-weight:bold;color:#856404;">
          <div style="margin-bottom:0.5rem;">⚠️ <strong>IMPORTANT:</strong></div>
          Please tell the customer to say their name <strong style="color:#1976d2;font-size:1.1em;">"${customerName}"</strong> during appointment's day.
        </div>
      `,
      confirmButtonColor: '#9c6b53',
      ...
      newUrl.searchParams.delete('customer_name');
